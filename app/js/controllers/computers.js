(function () {
    ...
    angular.module('quipApp').controller('ComputersController', ['$scope', function ($scope) {
        ...
        $scope.computers = [
            ...
            { name: 'PC06', processor: '2.5 GHz Intel Core i5', memory: '16 GB 1600 MHz DDR3', graphics: 'Intel HD Graphics 4000 5024 MB' },
            { name: 'PC07', processor: '2.5 GHz Intel Core i5', memory: '16 GB 1600 MHz DDR3', graphics: 'Intel HD Graphics 4000 5024 MB' }
        ];
